...
namespace RetlangTests
{
	...
	public class Demonstration
	{
		...
		class SummationSink
		{
			...
			public SummationSink(IProcessContext processContext, object topic, AutoResetEvent completionEvent, int expectedSum)
			{
				_processContext = processContext;
		...
		public void TestSummation()
		{
			...
			SummationSink summationSink = new SummationSink(processContextFour, "Summation Channel", completionEvent, expectedTotal);
